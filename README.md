...
- libnoise currently specifies CMake version 3.0 required.  Recent CMake wants to see at least version 3.5; I submitted an issue to the libnoise repo to change it.  In the meantime, easiest thing to do is to start make, let it error out, then edit external/libnoise/src/libnoise_download/CMakeLists.txt to bump the CMake version, save, and re-run make.
